...
encode_client_info(ClientInfo) ->
    #domain_ClientInfo{
        ...
        browser_info = encode_browser_info(maps:get(<<"browser_info">>, ClientInfo, undefined)),
        device_info = encode_device_info(maps:get(<<"device_info">>, ClientInfo, undefined)),
...
encode_device_info(DeviceInfo) ->
    #domain_DeviceInfo{
        ...
        screen_pixel_ratio = maybe_float(maps:get(<<"screenPixelRatio">>, DeviceInfo, undefined)),
